...
import 'package:lost_find_tracker/features/goods/presentation/widget/add_image_field.dart';
...
import 'package:lost_find_tracker/features/goods/presentation/widget/pick_image.dart';
...
class AddFoundItemsScreen extends StatelessWidget {
  AddFoundItemsScreen({Key? key}) : super(key: key);
                                ...
                                listener: (context, state) {
                                  if (state is AddGoodsSuccessState) {
                                    showSuccessSnackBar(context,
                                        'Success Add Found item', Colors.green);
